...
var image = panel.add("image", undefined, logo);
...
var panelGroupOne = panel.add("group", undefined, "panelGroupOne");
panelGroupOne.orientation = "row";
var buttonEight = panelGroupOne.add("iconbutton", undefined, logo);
buttonEight.size = buttonSize;
var buttonNine = panelGroupOne.add("button", undefined, "9");
buttonNine.size = buttonSize;
var buttonTen = panelGroupOne.add("button", undefined, "10");
buttonTen.size = buttonSize;
var buttonEleven = panelGroupOne.add("button", undefined, "11");
buttonEleven.size = buttonSize;
var panelGroupTwo = panel.add("group", undefined, "panelGroupTwo");
panelGroupTwo.orientation = "row";
var buttonTwelve = panelGroupTwo.add("button", undefined, "12");
buttonTwelve.size = buttonSize;
var buttonThirteen = panelGroupTwo.add("button", undefined, "13");
buttonThirteen.size = buttonSize;
var buttonFourteen = panelGroupTwo.add("button", undefined, "14");
buttonFourteen.size = buttonSize;
var buttonFifteen = panelGroupTwo.add("button", undefined, "15");
