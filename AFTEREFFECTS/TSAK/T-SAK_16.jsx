...
function SplitScreen(){
    ...
    if(app.project.activeItem.layer(IndexA).position.numKeys == 0){
    app.project.activeItem.layer(IndexA).position.setValue(PosA)}else{
    app.project.activeItem.layer(IndexA).position.setValueAtTime(CT, PosA)}

    if(app.project.activeItem.layer(IndexA).scale.numKeys == 0){
    app.project.activeItem.layer(IndexA).scale.setValue([100*CW/LayerA.width,100*CW/LayerA.width])}else{
    app.project.activeItem.layer(IndexA).scale.setValueAtTime(CT, [100*CW/LayerA.width,100*CW/LayerA.width])}

    if(app.project.activeItem.layer(IndexB).position.numKeys == 0){
    app.project.activeItem.layer(IndexB).position.setValue(PosB)}else{
    app.project.activeItem.layer(IndexB).position.setValueAtTime(CT, PosB)}
    
    if(app.project.activeItem.layer(IndexB).scale.numKeys == 0){
    app.project.activeItem.layer(IndexB).scale.setValue([100*CW/LayerB.width,100*CW/LayerB.width])}else{
    app.project.activeItem.layer(IndexB).scale.setValueAtTime(CT, [100*CW/LayerB.width,100*CW/LayerB.width])}
