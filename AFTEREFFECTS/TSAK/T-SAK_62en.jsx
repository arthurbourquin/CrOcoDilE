    ...
    function myScript(thisObj){
        ...
        res = "group{orientation:'column',\
                ...
                groupB: Group{orientation:'row',\
                    ButtonOne: Button{text:'Split screen H'},\
                    ButtonTwo: Button{text:'Split screen V'},\
                    ButtonThree: Button{text:'⊞'},\
                    ButtonFour: Button{text:''},\
                    ButtonFive: Button{text:''},\
                    ButtonSix: Button{text:''},\
                    ButtonSeven: Button{text:''},\
            },\
                groupC: Group{orientation:'row',\
                    ButtonOne: Button{text:'scale B'},\
                    ButtonTwo: Button{text:'scale split'},\
                    ButtonThree: Button{text:'scale uni'},\
