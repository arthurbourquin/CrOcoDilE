...
function WhiteToAlpha(){
    ...
    L1 = app.project.activeItem.layer(1);
        ...
        for(i=0;i<=NbSL;i++){
            ...
            app.project.activeItem.selectedLayers[i].property("Effects").property("Décalage des couches (TSAK)").property("Alpha =").setValue(7);
            app.project.activeItem.selectedLayers[i].Effects.addProperty("Suppression de halo coloré").name = "Suppression de halo coloré (TSAK)";
...
function CurvesHLS(){
    ...
    L1 = app.project.activeItem.layer(1);
        ...
        for(i=0;i<=NbSL;i++){
            app.project.activeItem.selectedLayers[i].Effects.addProperty("Mixeur de couches").name = "Mixeur de couches A (TSAK)";
            app.project.activeItem.selectedLayers[i].Effects.addProperty("Courbes").name = "CourbesTLS (TSAK)";
            app.project.activeItem.selectedLayers[i].property("Effects").property("CourbesTLS (TSAK)").property("Couche :").setValue(3);
            app.project.activeItem.selectedLayers[i].Effects.addProperty("Mixeur de couches").name = "Mixeur de couches B (TSAK)";
            app.project.activeItem.selectedLayers[i].property("Effects").property("Mixeur de couches B (TSAK)").property("Source").setValue(2);
        }
