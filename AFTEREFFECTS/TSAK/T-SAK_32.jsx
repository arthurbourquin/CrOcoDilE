{
    function myScript(thisObj){
        ...
        myPanel.grp.groupB.ButtonOneB.size = ButtonSize;
        myPanel.grp.groupB.ButtonTwoB.size = ButtonSize;
        myPanel.grp.groupB.ButtonThreeB.size = ButtonSize;
        myPanel.grp.groupB.ButtonFourB.size = ButtonSize;
        myPanel.grp.groupB.ButtonFiveB.size = ButtonSize;
        myPanel.grp.groupB.ButtonSixB.size = ButtonSize;
        myPanel.grp.groupB.ButtonSevenB.size = ButtonSize;
